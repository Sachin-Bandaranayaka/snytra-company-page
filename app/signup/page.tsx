      ...
      <div className="w-full lg:w-1/2 p-8 lg:p-12 flex items-center justify-center">
        <div className="max-w-md w-full">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-[#1e1800]">Create an Account</h1>
            <p className="text-gray-600 mt-2">Start managing your restaurant better today</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-[#d94e1f] focus:border-[#d94e1f]"
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link href="/login" className="text-[#d94e1f] hover:text-[#d94e1f]/90 font-medium">
              Log in
            </Link>
          </p>
        </div>
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        <div className="absolute inset-0 bg-gradient-to-l from-black/10 to-black/30">
          <div className="p-12 text-white max-w-lg mt-20">
            <h2 className="text-3xl font-bold mb-4">Transform Your Restaurant Operations</h2>
